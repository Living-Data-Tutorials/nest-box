...
You can also run functions on different variables of your datasets which you can select by using `$`. You can wrap these in different functions to calculate various things. Let's calculate the mean weight from our banding2 dataset and assign it to a new variable called mean_weight.
