...
![](TRES/tres.jpg){width = 100% .external}
...
![](TRES/Long_point_map.png){width = 100% .external}
...
![](TRES/thePoint.png){width = 100% .external}
...
![](TRES/theSewage.png){width = 100% .external}
...
![](TRES/mudCreek.png){width = 100% .external}
...
![](TRES/adult.png){width = 100% .external}
...
![](TRES/immature_female.png){width = 100% .external}
...
[]!(TRES/ornate.png){width = 100% .external}
...
Nice job! It looks like there is a difference between males and females in terms of wing chord measurements. Before moving forward, try measuring tail length and weight on your own. You'll see we have included what your graphs *should* look like below for both tail and weight means by sex.**Hint** Look at the example we just ran using the <aggregate> function first, then plot with <ggplot>.  
...
*Do these findings suggest that there is some level of sexual dimorphism in tree swallows? What type of pressures could lead to sexual dimorphism in tree swallows?* 
***
...
[]!(TRES/trade_offs.png){width = 100% .external}
...
You may have noticed that the second clutches are slightly smaller than the first clucthes! However, in order to confirm that there is a statistically significant difference between the two clutch sizes you would need to complete some sort of statistical analysis (e.g a t-test).
***
